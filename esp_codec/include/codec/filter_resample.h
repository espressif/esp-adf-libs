 ...
 *         If need change bits or not ensure source data infomation, please use rsp_filter_change_src_info to instead this function.
 *
...
/**
 * @brief  Set the source audio sample rate, the number of channels and bits per sample to be processed by the resample.
 *
 * @param  self      Audio element handle
 * @param  src_rate  The sample rate of stream data
 * @param  src_ch    The number channels of stream data
