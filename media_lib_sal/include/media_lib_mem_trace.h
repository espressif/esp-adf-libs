...
typedef enum {
    ...
    MEDIA_LIB_MEM_TRACE_ALL          = (MEDIA_LIB_MEM_TRACE_MODULE_USAGE | MEDIA_LIB_MEM_TRACE_LEAK | MEDIA_LIB_MEM_TRACE_SAVE_HISTORY),
...
typedef struct {
    ...
    __media_lib_os_caps_malloc_align  caps_malloc_align;  /*!< Malloc align by capabilities wrapper */
